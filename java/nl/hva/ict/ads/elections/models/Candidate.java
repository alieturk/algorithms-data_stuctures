...
public class Candidate {
    ...
    public static String fullName(String firstName, String lastNamePrefix, String lastName) {
        String[] names = {firstName, lastNamePrefix, lastName};
        ...
        for (String s : names) {
            Optional<String> name = Optional.ofNullable(s);
                    name.ifPresent(n->{
                        sb.append(n);
                        if ( !names[names.length - 1].equals(name.get()) ) sb.append(" ");
                    });
        }
    ...
    public boolean equals(Object o) {
        ...
        boolean nameEquals = Objects.equals(this.getFullName(), other.getFullName());
        boolean partyEquals = Objects.equals(this.getParty(), other.getParty());

        return partyEquals && nameEquals;
    }
