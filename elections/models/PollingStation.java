...
public class PollingStation {
    ...
    public PollingStation(String id, String zipCode, String name) {
        ...
        // initialise this.votesByCandidate with an appropriate Map implementation
    ...
    public void addVotes(Candidate candidate, int numberOfVotes) {
        //  add the number of votes for the candidate
    ...
    public Map<Party, Integer> getVotesByParty() {
        // accumulate the votes per candidate into a map of total vote counts by party
        Map<Party, Integer> votesByParty = new HashMap<>();
        votesByCandidate.forEach((candidate, numberOfVotes) -> {
            votesByParty.merge(candidate.getParty(), numberOfVotes, Integer::sum);
        });
