...
public class Party {
    ...
    public Party(int id, String name) {
        this.id = id;
        this.name = name;
        // initialise this.candidates with an appropriate Set implementation
    ...
    public Candidate addOrGetCandidate(Candidate newCandidate) {
        ...
        //  try to add the newCandidate to the set of candidates,
    ...
    public boolean equals(Object o) {
        ...
        // provide the equality criterion to identify unique party instances
        return Objects.equals(this.getId(), other.getId())
                && Objects.equals(this.getName(), other.getName()); // replace by a proper outcome
    }

    @Override
    public int hashCode() {
        //  provide a hashCode that is consistent with above equality criterion
        return Objects.hash(getId(), getName()); // replace by a proper outcome
    }
