...
public class Candidate {
    ...
    public static String fullName(String firstName, String lastNamePrefix, String lastName) {
        ...
        //  prepend optional lastNamePrefix and optional firstName
        //  to compose a unique and nicely formatted full name
        if (firstName != null && !firstName.isEmpty() && lastNamePrefix != null && !lastNamePrefix.isEmpty()) {
            fullName = firstName + " " + lastNamePrefix + " " + fullName;
        } else if (firstName != null && !firstName.isEmpty()) {
            fullName = firstName + " " + fullName;
        } else if (lastNamePrefix != null && !lastNamePrefix.isEmpty()) {
    ...
    public boolean equals(Object o) {
        ...
        //  provide the equality criterion to identify unique candidate instances
        return Objects.equals(this.getFullName(), other.getFullName())
                && Objects.equals(this.getParty(), other.getParty()); // replace by a proper outcome
    }

    @Override
    public int hashCode() {
        // provide a hashCode that is consistent with above equality criterion
        return Objects.hash(getFullName(), getParty()); // replace by a proper outcome
    }
